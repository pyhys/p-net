   ...
   uint16_t * p_pos)
{
   ...
   const uint16_t subslot = pf_pdport_loc_port_num_to_dap_subslot (loc_port_num);
   ...
   uint16_t * p_pos)
{
   ...
   if (pnal_get_port_statistics (net->fspm_cfg.if_cfg.main_port.if_name, &port_stats) != 0)
   {
