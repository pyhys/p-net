...
{
   BG_JOB_UPDATE_PORTS_STATUS = 0, /**< Update status for all ports  */
   BG_JOB_SAVE_ASE_NVM_DATA,       /**< Save non volatile ASE data to file */
   BG_JOB_SAVE_IM_NVM_DATA,        /**< Save non volatile IM data to file */
   BG_JOB_SAVE_PDPORT_NVM_DATA,    /**< Save non volatile PDPort data to file
                                    */
} pf_bg_job_t;
