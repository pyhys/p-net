...
``"DCP;DHCP"``. During the ART Tester test case DCP_OPTIONS_SUBOPTIONS some
aspects of DHCP shandling are tested.
...
+---------------+-------------------------------------------------------------+
| 5.6.3.11      | Context Management IP and Name Assignment                   |
+---------------+-------------------------------------------------------------+
